...
-- S	=>  Location: PIN_R16,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \G3|R~0_combout\ : std_logic;
...
\G3|R~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \G3|R~0_combout\ = ( \A~input_o\ & ( !\B~input_o\ ) ) # ( !\A~input_o\ & ( \B~input_o\ ) )
